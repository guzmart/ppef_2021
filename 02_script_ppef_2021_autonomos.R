...
ramos_pef2020apr_ppef2021 <- ramos %>% 
  filter(ciclo != 2019) %>% 
  filter(filter_ramos_auton(id_ramo)) %>% 
  mutate(
...
fiuf <- "Variación del presupuesto de los Ramos Autónomos"
fiuff <- "Monto aprobado en PEF2020 vs Monto de proyecto en PPEF 2021"
ggplot(ramos_pef2020apr_ppef2021 , 
       aes(
         x=monto_diferencia, 
         y=reorder(str_wrap(toupper(desc_ramo),15), as.numeric(monto_diferencia)), 
...
ggsave(filename = paste0(out, "02_Autónomos/01_00_ramos_pef2020apr_ppef2021.png"),
...
ggplot(ramos_pef2020mod_ppef2021, 
  ...
  theme(plot.title = element_text(size = 35, face = "bold" , hjust = 0.5),
        ...
        legend.title = element_blank(),
        legend.position = "none")
ggsave(filename = paste0(out, "02_Autónomos/02_00_ramos_pef2020mod_ppef2021.png"),
       width = 17, height = 20, dpi = 100)
...
fiuf <- "Variación del presupuesto de Ramos Autónomos por Modalidades"
fiuff <- "Monto aprobado en PEF2020 vs Monto de proyecto en PPEF 2021"
ggplot(mods_pef2020apr_ppef2021, 
  ...
  theme(plot.title = element_text(size = 35, face = "bold" , hjust = 0.5),
        ...
        legend.title = element_blank(),
        legend.position = "none")
ggsave(filename = paste0(out, "02_Autónomos/03_mods_pef2020apr_ppef2021.png"),
...
ggplot(mods_pef2020mod_ppef2021, 
  ...
  theme(plot.title = element_text(size = 35, face = "bold" , hjust = 0.5),
        ...
        legend.title = element_blank(),
        legend.position = "none")
ggsave(filename = paste0(out, "02_Autónomos/03_mods_pef2020mod_ppef2021.png"),
       width = 15, height = 22, dpi = 100)
...
for(i in 1:length(id_ramo_loop)){
  ...
  ggplot(
    ...
    theme(plot.title = element_text(size = 50, face = "bold" , hjust = 0.5),
          ...
          legend.title = element_blank(),
          legend.position = "none")
  ggsave(filename = paste0(out, "02_Autónomos/04_", unique(a$id_ramo), "_pp_pef2020apr_ppef2021.png"),
         width = 25, height = 35, dpi = 100, limitsize = FALSE)
}
...
for(i in 1:length(id_ramo_loop)){
  ...
  ggplot(
    ...
    theme(plot.title = element_text(size = 50, face = "bold" , hjust = 0.5),
          ...
          legend.title = element_blank(),
          legend.position = "none")
  ggsave(filename = paste0(out, "02_Autónomos/05_", unique(a$id_ramo), "_pp_pef2020mod_ppef2021.png"),
         width = 25, height = 35, dpi = 100, limitsize = FALSE)
}
...
for(i in 1:length(id_ramo_loop)){
  ...
  ggplot(
    ...
    theme(plot.title = element_text(size = 50, face = "bold" , hjust = 0.5),
          ...
          legend.title = element_blank(),
          legend.position = "none")
  ggsave(filename = paste0(out, "02_Autónomos/06_", unique(a$id_ramo), "_pef2020apr_ppef2021.png"),
...
for(i in 1:length(id_ramo_loop)){
  ...
  ggplot(
    ...
    theme(plot.title = element_text(size = 50, face = "bold" , hjust = 0.5),
          ...
          legend.title = element_blank(),
          legend.position = "none")
  ggsave(filename = paste0(out, "02_Autónomos/07_", unique(a$id_ramo), "_pef2020mod_ppef2021.png"),
         width = 30, height = 50, dpi = 100, limitsize = FALSE)
}
